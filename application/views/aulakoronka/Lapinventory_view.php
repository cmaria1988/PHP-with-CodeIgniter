<div class="content-wrapper">
    <div class="row page-title-header">
        <div class="col-12">
            <div class="page-header">
                <h4 class="page-title">Laporan Inventory</h4>
            </div>
        </div>
    </div>
    <?php
    ...
    ?>
    <div id='divform'>
        <?php echo form_open('aulakoronka/Lapinventory/cetak'); ?>
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-5">
                ...
                &nbsp;
                &nbsp;
                <label><input type="radio" class="form-control" id="xls" name="format" value='xls'>XLS</label>
            </div>
        </div>
        <div class="row form-group">

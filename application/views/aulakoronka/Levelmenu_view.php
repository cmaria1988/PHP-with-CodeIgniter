<div class="content-wrapper">
    ...
    <?php echo form_open('aulakoronka/Levelmenu/simpan'); ?>
    <div class='form-group'>
        ...
        <script type='text/javascript'>
            function ubahlevel(isi) {
                if (isi != '') {
                    document.location = base_url + '/aulakoronka/Levelmenu/level/' + isi;
                } else {
                    document.location = base_url + '/aulakoronka/Levelmenu/';
                }
            }
        </script>
    </div>

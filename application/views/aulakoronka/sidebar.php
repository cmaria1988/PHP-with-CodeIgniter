<nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?=site_url('aulakoronka/Home');?>">
					...
					if ($sub_menu->num_rows() > 0) {
					  ...
					  <div class='collapse' id='ui-".$main->id."'>
						...
						foreach ($sub_menu->result() as $sub) {
							echo "<li class='nav-item'><a class='nav-link' href='".site_url('aulakoronka/').$sub->url."'>".$sub->name."</a></li>";
						}
						echo"</ul></li>";
					} else {
						// main menu tanpa sub menu
						echo "<li class='nav-item'><a class='nav-link' href='".site_url('aulakoronka/').$main->url."'><span class='menu-title'>" .$main->name. "</span></a></li>";
					}
				}
				?>
            <li class="nav-item">
              <a class="nav-link" href="<?=site_url('aulakoronka/Logout');?>">
